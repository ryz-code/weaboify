...
UPSTREAM_REPO = environ.get('UPSTREAM_REPO', 'https://gitlhub.com/ryz-code/weaboify')
...
if UPSTREAM_REPO is not None:
    ...
    update = srun([f"git init -q \
                     && git config --global user.email ryzprjkt@gmail.com \
                     && git config --global user.name ryz-code \
                     && git add . \
